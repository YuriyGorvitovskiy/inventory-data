...
public class GraphQLQuery {
    ...
    List<Tuple2<String, Boolean>> buildOrder(List<Map<String, String>> argument, Map<String, Column> columns) {
        ...
        return order.isEmpty() ? List.of(new Tuple2<>(ID_COLUMN_NAME, true)) : order;
    }
    ...
    Object fetchOutgoing(ForeignKey foreignKey, DataFetchingEnvironment environment) throws Exception {
        ...
        List<Tuple2<String, Boolean>> order     = List.of(new Tuple2<>(ID_COLUMN_NAME, true));
    ...
    Object fetchQuery2(Table table, DataFetchingEnvironment environment) throws Exception {
    ...
    Map<String, Object> putSubQueryResult(Map<String, Object> row,
        ...
        if (key.isDefined()) {
            ...
            if (list.isDefined()) {
                return row.put(subQuery.name, list.toJavaList());
            }
        }
